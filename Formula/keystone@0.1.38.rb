class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.38'
  url 'https://github.com/wearedevx/keystone/archive/0.1.38.tar.gz'
  sha256 'bc41c0edb0e066ff1f4217a294ba97b0d8627c6ac446f2a444447de8ac539f7a'
  version '0.1.38'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-38---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.38'"
