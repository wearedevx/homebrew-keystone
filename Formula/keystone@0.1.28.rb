class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.28'
  url 'https://github.com/wearedevx/keystone/archive/0.1.28.tar.gz'
  sha256 '098aca77e1ed5054e309d7ab10a233f51b957eddc29684340ee4b09c407555a5'
  version '0.1.28'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-28---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.28'"
