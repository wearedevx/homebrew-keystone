class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.33'
  url 'https://github.com/wearedevx/keystone/archive/0.1.33.tar.gz'
  sha256 '0e538b64976db1258f34e9681cc4467d38ffe26577c314264ead1688eef54944'
  version '0.1.33'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-33---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.33'"
