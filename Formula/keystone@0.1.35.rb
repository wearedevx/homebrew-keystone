class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.35'
  url 'https://github.com/wearedevx/keystone/archive/0.1.35.tar.gz'
  sha256 '16f7bbea9f94989e58115d958af073a3b06265d7811f4c545caf14f8413b6336'
  version '0.1.35'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-35---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.35'"
