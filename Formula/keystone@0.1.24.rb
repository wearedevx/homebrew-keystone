class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.24'
  url 'https://github.com/wearedevx/keystone/archive/0.1.24.tar.gz'
  sha256 'bdc4471a94d561c845b3b7d39cb86b961f0b472ebd4002e07c0831e6529f56f1'
  version '0.1.24'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-24---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.24'"
