class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.75'
  url 'https://github.com/wearedevx/keystone/archive/0.1.75.tar.gz'
  sha256 'cec036adea2ed5969373169ca69e57ca3e06d8f3b076b95a111cd68e5f43b811'
  version '0.1.75'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-75---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.75'"
