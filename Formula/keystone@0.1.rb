class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.76'
  url 'https://github.com/wearedevx/keystone/archive/0.1.76.tar.gz'
  sha256 '425d576d7a782bda7f16a995d8632d276894c675de358f4c50d4156fdf0104f4'
  version '0.1.76'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-76---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.76'"
