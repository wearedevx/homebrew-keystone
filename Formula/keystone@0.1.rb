class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.52'
  url 'https://github.com/wearedevx/keystone/archive/0.1.52.tar.gz'
  sha256 '2a43d2b98f01c815db115f465982826657686d0d74237b3dbe025de636044239'
  version '0.1.52'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-52---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.52'"
