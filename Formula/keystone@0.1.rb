class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.60'
  url 'https://github.com/wearedevx/keystone/archive/0.1.60.tar.gz'
  sha256 '3e562c4e97551c8ea59a042bfa2dd1fdc1ebc093d26bfc6d7095923ec2e4b54c'
  version '0.1.60'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-60---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.60'"
