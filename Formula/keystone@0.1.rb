class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.125'
  url 'https://github.com/wearedevx/keystone/archive/0.1.125.tar.gz'
  sha256 'ae79590c4cd3042ed8f70f9c06f6c05e52cc1887257b231d480768cc692819d3'
  version '0.1.125'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-125---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.125'"
