class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.27'
  url 'https://github.com/wearedevx/keystone/archive/0.1.27.tar.gz'
  sha256 'dd9142c187823e2eed5650223e68b14c5820c1ad96f64794309401775fb1ee63'
  version '0.1.27'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-27---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.27'"
