...
class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.2.32'
  url 'https://github.com/wearedevx/keystone/archive/0.2.32.tar.gz'
  sha256 '884a302d7cc837dc080d6602492c2ab950e1cd8c354d4857b29b61dfc53103ac'
  version '0.2.32'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-2-32---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.2.32'"
