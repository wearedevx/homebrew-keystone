class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.2.12'
  url 'https://github.com/wearedevx/keystone/archive/0.2.12.tar.gz'
  sha256 'fdb62e412fe733a2c803899ea16ebd3f22c9a4c7fd29cfdae708063a668576e4'
  version '0.2.12'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-2-12---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.2.12'"
