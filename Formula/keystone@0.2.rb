class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.2.0'
  url 'https://github.com/wearedevx/keystone/archive/0.2.0.tar.gz'
  sha256 '2097be8bb3aa37590ee77583c5cbdeccb7e88410a841abb591365143adf9392b'
  version '0.2.0'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-2-0---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.2.0'"
