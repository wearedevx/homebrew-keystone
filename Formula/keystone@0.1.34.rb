class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.34'
  url 'https://github.com/wearedevx/keystone/archive/0.1.34.tar.gz'
  sha256 'bc82fdb08484e9b0ca9f5b75609df9424f628cce6992263c3b24872bc870a4d0'
  version '0.1.34'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-34---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.34'"
