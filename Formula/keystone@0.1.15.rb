class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.15'
  url 'https://github.com/wearedevx/keystone/archive/0.1.15.tar.gz'
  sha256 'e7b7d116acddd4e897204d5685bd8ed5056de9c867c77df322c69881c609a419'
  version '0.1.15'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-15---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.15'"
