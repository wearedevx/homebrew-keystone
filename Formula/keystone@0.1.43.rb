class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.43'
  url 'https://github.com/wearedevx/keystone/archive/0.1.43.tar.gz'
  sha256 'a741a073912d8cbb5df688e562464465fc30a08afbb046b924f151dc25b31d4d'
  version '0.1.43'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-43---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.43'"
