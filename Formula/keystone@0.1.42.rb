class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.42'
  url 'https://github.com/wearedevx/keystone/archive/0.1.42.tar.gz'
  sha256 '2ce26352dc86d10ed37a87a5a7b5974c3d9d424545f46683c64df792de5a511a'
  version '0.1.42'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-42---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.42'"
