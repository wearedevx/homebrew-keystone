class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.29'
  url 'https://github.com/wearedevx/keystone/archive/0.1.29.tar.gz'
  sha256 '699acf2b97d2670400cd8420b6888b69e8fabbd188291f6dd93773f585113a92'
  version '0.1.29'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-29---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.29'"
