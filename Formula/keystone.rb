class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.108'
  url 'https://github.com/wearedevx/keystone/archive/0.1.108.tar.gz'
  sha256 '48131b8af0d8f0f5330b8b6d6d7ff600519666a669ec24ae2822e2e925175454'
  version '0.1.108'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-108---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.108'"
