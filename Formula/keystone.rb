class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.126'
  url 'https://github.com/wearedevx/keystone/archive/0.1.126.tar.gz'
  sha256 '44102c2ea88d56bcd32e8efd3275cb54850696a35b507d609d8f0f45cba0969b'
  version '0.1.126'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-126---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.126'"
