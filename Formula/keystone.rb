class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.107'
  url 'https://github.com/wearedevx/keystone/archive/0.1.107.tar.gz'
  sha256 '268d3009f2523df4cf6c19165efaa109e43fbf9a297a1ea6520235ed3280d97e'
  version '0.1.107'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-107---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.107'"
