class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.61'
  url 'https://github.com/wearedevx/keystone/archive/0.1.61.tar.gz'
  sha256 '0ce04015cbae471be78e451ec1b2ea91b481006c2c87af2f319d016faf5702f5'
  version '0.1.61'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-61---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.61'"
