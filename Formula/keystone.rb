class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.85'
  url 'https://github.com/wearedevx/keystone/archive/0.1.85.tar.gz'
  sha256 '961537ae1637b45060311d06698e7f3fdfe9942e9c5f3bcbec7d6fe30c116e38'
  version '0.1.85'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-85---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.85'"
