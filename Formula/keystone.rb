class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.53'
  url 'https://github.com/wearedevx/keystone/archive/0.1.53.tar.gz'
  sha256 '343f7b24449e3079c94ca05974ffffeb331de566a79fcbb9395687d0b8edb894'
  version '0.1.53'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-53---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.53'"
