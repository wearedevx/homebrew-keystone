class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.31'
  url 'https://github.com/wearedevx/keystone/archive/0.1.31.tar.gz'
  sha256 '319bafb6c603364d2d920998b5fb8951c848bd5b8ffd37c8fdbdfab1eafb05c9'
  version '0.1.31'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-31---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.31'"
