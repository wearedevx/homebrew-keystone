class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.30'
  url 'https://github.com/wearedevx/keystone/archive/0.1.30.tar.gz'
  sha256 '19d4f4f7e28d77942074131d9d89a5881f7eb873b87c21b599730c306080baca'
  version '0.1.30'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-30---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.30'"
