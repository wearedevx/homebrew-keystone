class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.39'
  url 'https://github.com/wearedevx/keystone/archive/0.1.39.tar.gz'
  sha256 '70cd866208553dd39ac6636cb0771061991c46d4035ccef21bc954d6e049bcb2'
  version '0.1.39'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-39---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.39'"
