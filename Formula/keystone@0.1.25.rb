class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.25'
  url 'https://github.com/wearedevx/keystone/archive/0.1.25.tar.gz'
  sha256 '6143cd2cddaeb3b63fcd2830e07668aa79ba4fbbb999894b2f2602270064cf14'
  version '0.1.25'
  ...
  def install
    ...
    versionFlag = "-X '#{constantsPkg}.Version=0.1.25'"
