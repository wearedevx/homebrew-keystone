class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.14'
  url 'https://github.com/wearedevx/keystone/archive/0.1.14.tar.gz'
  sha256 '0738571e127083db1f6332a5f1c48ce9308028d75b0ecbef2d5bb3f0dfcf21a2'
  version '0.1.14'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-14---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.14'"
