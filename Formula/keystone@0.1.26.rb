class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.26'
  url 'https://github.com/wearedevx/keystone/archive/0.1.26.tar.gz'
  sha256 '0cbed522833912ff1f67718547c98420f7f5e060b7296c75d4714d8f61ceedab'
  version '0.1.26'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-26---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.26'"
