class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.41'
  url 'https://github.com/wearedevx/keystone/archive/0.1.41.tar.gz'
  sha256 'a9b935a10619cead2e2f161d6bbaed0f7c359a08a774f8ef2a05ebe404c8ddff'
  version '0.1.41'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-41---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.41'"
