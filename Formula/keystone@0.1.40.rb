class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.40'
  url 'https://github.com/wearedevx/keystone/archive/0.1.40.tar.gz'
  sha256 '69f5cf24458204c97d0cfde1103829fabca268abe1abfe07f94bbb7b0bf2da20'
  version '0.1.40'
  ...
  def install
    ...
    apiFlag = "-X '#{clientPkg}.ApiURL=https://v0-1-40---keystone-server-esk4nrfqlq-oa.a.run.app'"
    authProxyFlag = "-X '#{authPkg}.authRedirectURL=https://europe-west6-keystone-245200.cloudfunctions.net/auth-proxy/'"

    versionFlag = "-X '#{constantsPkg}.Version=0.1.40'"
