class Keystone < Formula
  ...
  head 'https://github.com/wearedevx/keystone.git', branch: '0.1.9'
  url 'https://github.com/wearedevx/keystone/archive/0.1.9.tar.gz'
  sha256 'f329b90a464b92e22feea24aac5e77d388cc6d29746bed0f04902725b5219f3d'
  version '0.1.9'
  ...
  def install
    ...
    versionFlag = "-X '#{constantsPkg}.Version=0.1.9'"
